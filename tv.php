                ...
                <div class="col-md-10 col-sm-10 col-12">
                    <div class="row">
                        <div class="col-md-4 col-sm-4 col-12">
                            ...
                            <?php
                             $tv="tv";
                             $query="SELECT * FROM product WHERE category='$tv' limit 0,3";
                        ...
                        <div class="col-md-4 col-sm-4 col-12">
                            <?php
                              $tv="tv";
                              $query="SELECT * FROM product WHERE category='$tv' limit 3,3";
                                $data=mysqli_query($conn,$query);
                                while($result=mysqli_fetch_array($data))
                                {
                                     $id=$result['id'];
                         ...
                         <div class="col-md-4 col-sm-4 col-12">
                            ...
                            <?php
                             $tv="tv";
                             $query="SELECT * FROM product WHERE category='$tv' limit 6,3";
                                $data=mysqli_query($conn,$query);
                                while($result=mysqli_fetch_array($data))
                                {
                                     $id=$result['id'];
