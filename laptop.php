                ...
                <div class="col-md-10 col-sm-10 col-12">
                    <div class="row">
                        <div class="col-md-4 col-sm-4 col-12">
                            ...
                            <?php
                             $laptop="laptop";
                             $query="SELECT * FROM product WHERE category='$laptop' limit 0,3";
                        ...
                        <div class="col-md-4 col-sm-4 col-12">
                            <?php
                             $laptop="laptop";
                             $query="SELECT * FROM product WHERE category='$laptop' limit 3,3";
                                $data=mysqli_query($conn,$query);
                                while($result=mysqli_fetch_array($data))
                                {
                                     $id=$result['id'];
                         ...
                         <div class="col-md-4 col-sm-4 col-12">
                            ...
                            <?php
                             $laptop="laptop";
                             $query="SELECT * FROM product WHERE category='$laptop' limit 6,3";
                                $data=mysqli_query($conn,$query);
                                while($result=mysqli_fetch_array($data))
                                {
                                     $id=$result['id'];
